...
hadron scope list [--owner-org <ref> | --owner-app <ref> | --owner-agent <ref>] [--name <n>] | get <name|id> | create <name> (--owner-org|--owner-app|--owner-agent <ref>) -m <memory>… [--description <d>] | update <name|id> [--name <new>] [-m <memory>…] [--description <d>] | rm <name|id> [--yes] | explain <name|id> [--loc <address>]
