...
// (mergeNodes, #186). $source / $target are ids or fully-qualified URNs.
// `include` selects which fields fold in (ABSTRACT/CONTENT/DATA/DESCRIPTION/
// EDGES/PROPERTIES/TAGS); `deleteSource` hard-deletes the source afterwards.
